	...
	function Wysiwyg() {
		this.controls = {
			...
			insertOrderedList: {
				...
				visible: true,
				tags: ["ol"],
				tooltip: "Inserir lista ordenada"
			},
			...
			insertUnorderedList: {
				...
				visible: true,
				tags: ["ul"],
				tooltip: "Inserir lista não ordenada"
			},
			...
			ltr: {
				...
				tooltip : "Esquerda para direita"
			},

			outdent: {
				groupIndex: 2,
				visible: true,
				tooltip: "Remover identação"
			},
		...
		this.defaults = {
			...
			maxLength: 0,
			messages: {
				nonSelection: "Selecione o texto que desejar linkar"
			},
